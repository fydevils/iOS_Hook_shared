...
#import "AMapGeoFenceRegionDelegate-Protocol.h"
#import "AMapLocationManagerDelegate-Protocol.h"
#import "AMapLocationSearchManagerDelegate-Protocol.h"

@class AMapLocationManager, AMapLocationSearchManager, CLLocation, NSMapTable, NSMutableArray, NSString;
@protocol AMapGeoFenceManagerDelegate, OS_dispatch_queue;
...
@interface AMapGeoFenceManager : NSObject <AMapLocationManagerDelegate, AMapGeoFenceRegionDelegate, AMapLocationSearchManagerDelegate>
{
    ...
    NSMutableArray *_pauseMonitorRegions;
    NSMapTable *_regionIdentifiers;
    CLLocation *_latestLocation;
    double _startRegionCLManagerTimeInterval;
}

@property(nonatomic) double startRegionCLManagerTimeInterval; // @synthesize startRegionCLManagerTimeInterval=_startRegionCLManagerTimeInterval;
...
@property(retain, nonatomic) NSMutableArray *pauseMonitorRegions; // @synthesize pauseMonitorRegions=_pauseMonitorRegions;
...
- (void)removeAllPauseRegions;
- (_Bool)pauseRegion:(id)arg1;
- (void)registerRegion:(id)arg1;
- (_Bool)startMonitoringForRegion:(id)arg1;
...
- (_Bool)startTheGeoFenceRegion:(id)arg1;
- (id)startGeoFenceRegionsWithCustomID:(id)arg1;
- (_Bool)pauseTheGeoFenceRegion:(id)arg1;
- (id)pauseGeoFenceRegionsWithCustomID:(id)arg1;
- (id)pausedGeoFenceRegionsWithCustomID:(id)arg1;
- (id)monitoringGeoFenceRegionsWithCustomID:(id)arg1;
- (id)geoFenceRegionsWithCustomID:(id)arg1;
- (unsigned long long)statusWithGeoFenceRegion:(id)arg1;
