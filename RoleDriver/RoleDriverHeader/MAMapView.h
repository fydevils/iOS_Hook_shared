...
@class AMapNetworkManager, CLLocationManager, MAAngleIndicator, MAAnnotationContainerView, MACircle, MACompassView, MAENInlandMapTileOverlay, MAGLESResourceProvider, MAIndoorInfo, MAIndoorView, MAInternalMapStatus, MAMapRender, MAOverlayContainerView, MAScaleViewLite, MATapPanToZoomGestureRecognizer, MAUserLocation, MAUserLocationRepresentation, MAViewRecycler, MAWorldMapTileOverlay, MapStatus, NSData, NSDictionary, NSMutableArray, NSNumber, NSOperation, NSString, UIImageView, UILabel, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
@protocol MAAnnotation, MAMapViewDelegate;

@interface MAMapView : UIView <UIGestureRecognizerDelegate, CLLocationManagerDelegate, MAMapEngineMapViewDelegate, MAMapRenderDelegate, MAOverlayContainerViewDelegate, MAAnnotationContainerViewDelegate, MACompassViewDelegate, MAIndoorViewDelegate>
{
    MAMapRender *_render;
    ...
    NSData *_origUnzippedStyleData;
    NSData *_origStyleTextureData;
    NSData *_offlineStyleData_nonWeb;
    NSData *_offlineStyleData;
    NSData *_onlineStyleData;
    NSData *_textureStyleData;
    int _authResult;
    _Bool _ignoreAuthFlag;
...
- (_Bool)isVisibleMapRectPartlyInland;
- (_Bool)isVisibleMapRectPartlyAbroad;
- (_Bool)isVisibleMapRectAbsolutelyInland;
- (_Bool)isVisibleMapRectAbsolutelyAbroad;
...
- (void)setCoordinate:(struct CLLocationCoordinate2D)arg1 atPoint:(struct CGPoint)arg2 animated:(_Bool)arg3;
...
- (id)getDecryptedStyleDataFromWebData:(id)arg1;
- (id)getStyleSettingFromData:(id)arg1 isDataOfVersion2:(_Bool)arg2 ignoreTexture:(_Bool)arg3;
- (id)originalIcon5Data;
- (void)onHandleOnlineStyleData:(id)arg1;
- (void)onHandleOnlineStyleDowloadResult:(id)arg1 error:(id)arg2;
