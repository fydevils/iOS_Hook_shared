...
@property(nonatomic) _Bool optimizeEnabled; // @synthesize optimizeEnabled=_optimizeEnabled;
...
- (void)renderStrokedRegionWithPoints:(struct CGPoint *)arg1 pointCount:(unsigned long long)arg2 fillColor:(id)arg3 strokeColor:(id)arg4 strokeLineWidth:(double)arg5 strokeLineJoinType:(int)arg6 strokeLineDash:(unsigned long long)arg7 usingTriangleFan:(_Bool)arg8;
...
- (void)renderLinesWithPoints:(struct CGPoint *)arg1 pointCount:(unsigned long long)arg2 strokeColors:(id)arg3 drawStyleIndexes:(id)arg4 isGradient:(_Bool)arg5 lineWidth:(double)arg6 looped:(_Bool)arg7 LineJoinType:(int)arg8 LineCapType:(int)arg9 lineDash:(unsigned long long)arg10;
- (void)renderLinesWithPoints:(struct CGPoint *)arg1 pointCount:(unsigned long long)arg2 strokeColor:(id)arg3 lineWidth:(double)arg4 looped:(_Bool)arg5 LineJoinType:(int)arg6 LineCapType:(int)arg7 lineDash:(unsigned long long)arg8;
