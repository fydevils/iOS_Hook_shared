...
@interface MTAConfig : NSObject
{
    ...
    NSString *_op;
    NSString *_cn;
    NSString *_commonJsonAttrs;
    NSString *_customerUserID;
    NSString *_account;
    NSString *_accountExt;
    NSString *_qq;
    NSString *_tcpDomainOrIP;
    unsigned long long _tcpPort;
    NSString *_httpsUrl;
    NSString *_encryptName;
    id <MTAVIPProtocol> _vipHandler;
}

+ (id)getInstance;
@property(retain, nonatomic) id <MTAVIPProtocol> vipHandler; // @synthesize vipHandler=_vipHandler;
@property(copy, nonatomic) NSString *encryptName; // @synthesize encryptName=_encryptName;
@property(nonatomic) _Bool ifCustomEncrypt; // @synthesize ifCustomEncrypt=_ifCustomEncrypt;
@property(nonatomic) _Bool ifGZip; // @synthesize ifGZip=_ifGZip;
@property(copy, nonatomic) NSString *httpsUrl; // @synthesize httpsUrl=_httpsUrl;
@property(nonatomic) _Bool ifVIPEnable; // @synthesize ifVIPEnable=_ifVIPEnable;
@property(nonatomic) unsigned long long tcpPort; // @synthesize tcpPort=_tcpPort;
@property(copy, nonatomic) NSString *tcpDomainOrIP; // @synthesize tcpDomainOrIP=_tcpDomainOrIP;
@property(nonatomic) _Bool ifHttps; // @synthesize ifHttps=_ifHttps;
...
@property(copy, nonatomic) NSString *commonJsonAttrs; // @synthesize commonJsonAttrs=_commonJsonAttrs;
