...
@class MTAGCDAsyncReadPacket, MTAGCDAsyncSocketPreBuffer, MTAGCDAsyncWritePacket, NSData, NSMutableArray, NSString, NSURL;
@protocol MTAGCDAsyncSocketDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface MTAGCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <MTAGCDAsyncSocketDelegate> delegate;
    ...
    MTAGCDAsyncReadPacket *currentRead;
    MTAGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    MTAGCDAsyncSocketPreBuffer *preBuffer;
...
@property __weak id <MTAGCDAsyncSocketDelegate> delegate;
