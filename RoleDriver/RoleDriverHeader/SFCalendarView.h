...
@protocol SFCalendarViewDataSource, SFCalendarViewDelegate;

@interface SFCalendarView : UIView <UICollectionViewDataSource, UICollectionViewDelegate>
{
    ...
    id <SFCalendarViewDataSource> _dataSource;
    id <SFCalendarViewDelegate> _delegate;
...
@property(nonatomic) __weak id <SFCalendarViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <SFCalendarViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
