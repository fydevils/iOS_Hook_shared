...
@class NSMutableArray, NSString, SFCheckRecordModel, UITableView;

@interface SFCheckAbnormalDetailVC : UIViewController <UITableViewDataSource, UITableViewDelegate>
{
