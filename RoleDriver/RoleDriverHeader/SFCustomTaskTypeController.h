...
@protocol SFCustomTaskTypeControllerDelegate;

@interface SFCustomTaskTypeController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
    id <SFCustomTaskTypeControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <SFCustomTaskTypeControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
