...
@class SFBidDetailPackageLineView, SFImgTitleView, SFToCBidModel, SFToCBidRemarkView, UIButton, UIImageView, UILabel, UIView;

@interface SFNewBidDetailPackageCell : UITableViewCell
{
    _Bool _showMore;
