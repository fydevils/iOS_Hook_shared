...
#import "SFAddReimbursementDetailDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSMutableArray, NSString, SFDriverRouteModel, UITableView;

@interface SFReimbursementVC : UIViewController <UITableViewDelegate, UITableViewDataSource, SFAddReimbursementDetailDelegate>
{
...
- (void)reimbursementDetailSuccess;
