...
@interface SFTempDatePicker : UIView <UIPickerViewDelegate, UIPickerViewDataSource>
{
    long long yearIndex;
...
- (id)initWithTitle:(id)arg1 datePickerStyle:(int)arg2 didSelected:(CDUnknownBlockType)arg3 canceled:(CDUnknownBlockType)arg4;
