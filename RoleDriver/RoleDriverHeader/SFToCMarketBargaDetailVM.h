...
@interface SFToCMarketBargaDetailVM : NSObject
{
    ...
    long long _bargaDetailState;
    NSString *_topTipTxt;
}

@property(retain, nonatomic) NSString *topTipTxt; // @synthesize topTipTxt=_topTipTxt;
@property(nonatomic) long long bargaDetailState; // @synthesize bargaDetailState=_bargaDetailState;
