...
@class NSArray, NSTimer, SFLinePointView, SFToCBidModel, SFToCBidRemarkView, SFToCDistanceView, UIButton, UIImageView, UILabel, UIView;

@interface SFToCMarketNewOneCell : UITableViewCell
{
    NSTimer *_timer;
