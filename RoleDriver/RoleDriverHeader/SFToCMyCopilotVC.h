...
#import "SFToCMyCopilotCellDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSMutableArray, NSString, UIButton, UITableView;

@interface SFToCMyCopilotVC : SFToCBaseVC <UITableViewDataSource, UITableViewDelegate, SFToCMyCopilotCellDelegate>
{
...
- (void)inviteCopilotSucess;
- (void)pushFillCopilotPhoneVC;
- (void)alertWithNOApprove;
- (void)inviteBtnAction;
- (void)loadTestData;
- (void)loadData;
- (void)refreshUIWithRequestSuccess:(_Bool)arg1;
- (void)createUI;
- (void)viewDidLoad;
