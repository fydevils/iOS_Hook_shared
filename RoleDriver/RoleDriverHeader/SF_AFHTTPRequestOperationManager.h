...
@class NSOperationQueue, NSURL, NSURLCredential, SF_AFHTTPRequestSerializer, SF_AFHTTPResponseSerializer, SF_AFNetworkReachabilityManager, SF_AFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, SF_AFURLRequestSerialization, SF_AFURLResponseSerialization;

@interface SF_AFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    SF_AFHTTPRequestSerializer<SF_AFURLRequestSerialization> *_requestSerializer;
    SF_AFHTTPResponseSerializer<SF_AFURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    SF_AFSecurityPolicy *_securityPolicy;
    SF_AFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) SF_AFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) SF_AFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) SF_AFHTTPResponseSerializer<SF_AFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) SF_AFHTTPRequestSerializer<SF_AFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
