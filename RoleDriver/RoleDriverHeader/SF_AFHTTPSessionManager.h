...
#import "SF_AFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSURL, SF_AFHTTPRequestSerializer, SF_AFHTTPResponseSerializer;
@protocol SF_AFURLRequestSerialization, SF_AFURLResponseSerialization;

@interface SF_AFHTTPSessionManager : SF_AFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) SF_AFHTTPResponseSerializer<SF_AFURLResponseSerialization> *responseSerializer;
