...
#import "SF_AFMultipartFormData-Protocol.h"

@class NSMutableURLRequest, NSString, SF_AFMultipartBodyStream;

@interface SF_AFStreamingMultipartFormData : NSObject <SF_AFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    SF_AFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) SF_AFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
