...
@class NSData, NSDictionary, NSError, NSInputStream, NSObject, NSOutputStream, NSRecursiveLock, NSSet, NSString, NSURLConnection, NSURLCredential, NSURLRequest, NSURLResponse, SF_AFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue;

@interface SF_AFURLConnectionOperation : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSSecureCoding, NSCopying>
{
