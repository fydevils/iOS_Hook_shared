...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, SF_AFNetworkReachabilityManager, SF_AFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, SF_AFURLResponseSerialization;

@interface SF_AFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <SF_AFURLResponseSerialization> _responseSerializer;
...
@property(retain, nonatomic) id <SF_AFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
