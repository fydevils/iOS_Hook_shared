...
@class NSMutableData, NSProgress, NSString, NSURL, SF_AFURLSessionManager;

@interface SF_AFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    SF_AFURLSessionManager *_manager;
...
@property(nonatomic) __weak SF_AFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
