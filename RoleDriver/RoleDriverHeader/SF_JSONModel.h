...
#import "AbstractSF_JSONModelProtocol-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSString;

@interface SF_JSONModel : NSObject <AbstractSF_JSONModelProtocol, NSSecureCoding>
{
...
- (_Bool)__isSF_JSONModelSubClass:(Class)arg1;
